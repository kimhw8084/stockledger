...
export const getProviderHealth = async (): Promise<ProviderHealthEntry[]> => [
  { provider: "Stooq", configured: false, status: "Unconfigured", mode: "On Demand", note: "Public research-only adapter; it cannot activate a production managed feed or establish commercial rights. CSV import works offline.", endpoint: "q/d/l" },
