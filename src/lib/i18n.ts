...
const dict: Record<AppLanguage, Record<string, DictValue>> = {
  en: {
    ...
    "settings.notifications.disableConfirmBody": "This withdraws your consent, stops future notification delivery, and clears allowed channels. Your saved destination and other notification settings stay unchanged.",
  ...
  ko: {
    ...
    "settings.notifications.disableConfirmBody": "동의를 철회하고 이후 알림 전달을 중지하며 허용된 채널을 비웁니다. 저장된 수신 주소와 다른 알림 설정은 그대로 유지됩니다.",
