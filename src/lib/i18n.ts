...
const dict: Record<AppLanguage, Record<string, DictValue>> = {
  en: {
    ...
    "workspace.handoff.title": "Local worker review handoff",
    "workspace.handoff.body": "After a one-time folder choice, this browser checks worker evidence when the app opens and appends it to this workspace. The worker writes only small evaluation batches and reads a receipt from that folder. A scheduled run still needs your configured scheduler and an awake machine; this is not a live service or an email receipt.",
    "workspace.handoff.chooseFolder": "Choose worker folder",
    "workspace.handoff.changeFolder": "Change worker folder",
    "workspace.handoff.checkNow": "Check for worker updates",
    "workspace.handoff.connected": "Local worker folder connected.",
    "workspace.handoff.checked": "Local worker folder checked.",
    "workspace.handoff.lastApplied": ({ at }: Record<string, string | number> = {}) => `Last applied: ${at ?? "unknown"}`,
    "workspace.handoff.pendingCount": ({ count }: Record<string, string | number> = {}) => `${count ?? 0} worker update(s) still pending.`,
    "workspace.handoff.status.none": "No local worker folder connected",
    "workspace.handoff.status.pending": "Waiting for worker evidence or folder permission",
    "workspace.handoff.status.available": "Worker evidence is available",
    "workspace.handoff.status.applied": "Worker evidence applied to this workspace",
    "workspace.handoff.status.stale": "Worker handoff is older than 48 hours",
    "workspace.handoff.status.partial": "Partial worker history is available; more may be pending",
    "workspace.handoff.status.missed": "Worker reports missed or partial scheduled sessions",
    "workspace.handoff.status.conflict": "Owner changes conflict with this update; nothing was applied",
    "workspace.handoff.status.failed": "Handoff could not finish; retry is available",
    "workspace.handoff.status.recovered": "A prior valid workspace copy was restored",
    "workspace.handoff.error.permission_required": "Grant this browser access to the selected folder to check worker evidence.",
    "workspace.handoff.error.handoff_unavailable": "The selected folder could not be read or acknowledged. Retry after checking folder access.",
    "workspace.handoff.error.invalid_handoff": "The handoff file failed validation. The saved workspace remains unchanged.",
    "workspace.handoff.error.workspace_mismatch": "The handoff belongs to another workspace. No evidence was applied.",
    "workspace.handoff.error.sequence_gap": "A worker update is missing from the sequence. No evidence was applied.",
    "workspace.handoff.error.owner_state_changed": "This Eye changed after the worker used it. Review the conflict before retrying.",
    "workspace.handoff.error.identity_collision": "The worker reused an evidence identity for different content. No evidence was applied.",
    "workspace.handoff.error.storage_write_failed": "The app could not save the update. Its previous saved copy remains available.",
    "workspace.handoff.error.acknowledgement_failed": "Evidence is saved in the app, but the worker has not received its receipt yet.",
    ...
    "settings.notifications.title": "Notification delivery",
    "settings.notifications.note": "External delivery is off until you explicitly consent, choose email, and save a destination. The local worker must be running; the Expo app does not send email in the background.",
    "settings.notifications.configured": "Email destination saved",
    "settings.notifications.unconfigured": "Consent or destination missing",
    "settings.notifications.enabled": "Enabled",
    "settings.notifications.off": "Off",
    "settings.notifications.email": "Email destination",
    "settings.notifications.emailPlaceholder": "name@example.com",
    "settings.notifications.enable": "Enable email delivery",
    "settings.notifications.disable": "Opt out and cancel future delivery",
    "settings.notifications.disableConfirmTitle": "Turn off notification delivery?",
    "settings.notifications.disableConfirmBody": "This saves your opt-out and clears allowed delivery channels. The local worker may show a pending handoff until it receives the saved preference.",
    "settings.notifications.disableConfirmCancel": "Cancel",
    "settings.notifications.disableConfirmConfirm": "Turn off notifications",
    "settings.notifications.disableConfirmStatusNote": "This saves a preference only. It does not confirm that a worker or provider has processed the change.",
    "settings.notifications.saveFailed": "Notification preferences could not be saved. No changes were made.",
    "settings.notifications.disableSaveFailed": "The preference was not changed. Retry the save or cancel.",
    "settings.notifications.mode": "Delivery mode",
    "settings.notifications.mode.immediate": "Immediate",
    "settings.notifications.mode.digest": "Digest",
    "settings.notifications.digestTime": "Digest time (HH:MM)",
    "settings.notifications.quietHours": "Quiet hours",
    "settings.notifications.quietStart": "Start (HH:MM)",
    "settings.notifications.quietEnd": "End (HH:MM)",
    "settings.notifications.quietEnable": "Hold during quiet hours",
    "settings.notifications.quietDisable": "Disable quiet hours",
    "settings.notifications.privacy": "Content privacy",
    "settings.notifications.privacy.minimal": "Minimal safe message",
    "settings.notifications.privacy.rich": "Richer explicit content",
    "settings.notifications.save": "Save notification preferences",
    "settings.notifications.lastStatus": "Last delivery status: worker-only; this app does not claim a receipt.",
    "settings.notifications.workerStatus": "Delivery receipts are recorded by the server-only local worker, not by this app surface. A pending alert is not a delivered notification.",
    "settings.notifications.handoffNote": "Local preference changes take effect in the separate worker only after you explicitly export this backup and import it there.",
    "settings.notifications.pendingWorkerHandoff": "Pending worker handoff: this app preference is newer than the last worker-applied preference.",
    "settings.notifications.noLastKnownState": "No last-known worker delivery state has been imported yet.",
    "settings.notifications.lastKnownState": ({ state, at, attempts }: Record<string, string | number> = {}) => `Last-known worker state (not live monitoring): ${state ?? "none"}; recorded ${at ?? "unknown"}; attempts ${attempts ?? 0}.`,
    "settings.notifications.state.none": "No delivery yet",
    "settings.notifications.state.pending": "Pending",
    "settings.notifications.state.held": "Held",
    "settings.notifications.state.claimed": "In progress",
    "settings.notifications.state.delivered": "Confirmed by test/provider contract",
    "settings.notifications.state.failed": "Failed — retry budget exhausted",
    "settings.notifications.state.retry-wait": "Retry waiting",
    "settings.notifications.state.canceled": "Canceled / disabled",
    "settings.notifications.state.blocked-unconfigured": "Blocked — worker channel unconfigured",
    "settings.notifications.state.ambiguous": "Ambiguous — provider outcome needs reconciliation",
    "settings.notifications.privacyNote": "Minimal content never includes thesis text, notes, holdings, evidence, or cloud payloads.",
    ...
    "eyes.detail.noVersion": "Version not recorded",
    "eyes.detail.cadenceElapsed": "The recipe review cadence has elapsed.",
    ...
    "eyes.create.persistenceNote": "Saving records monitoring intent only. It does not place a trade or recommend an investment action.",
    "eyes.create.optionalNote": "Add these details when they help with review. You can save without them.",
    "eyes.create.rangePositive": "Enter a number greater than zero, or leave this optional field blank.",
    "eyes.create.rangeLowOrder": "Entry low must not be above entry high.",
    "eyes.create.rangeHighOrder": "Entry high must not be below entry low.",
    "eyes.create.submit": "Create Eye",
    "authoring.required": "Required",
    "authoring.requiredSection": "Required to create",
    "authoring.optionalSection": "Optional context",
    "authoring.noMatches": "No matches. Change the search and try again.",
    ...
    "journal.composer.editTitle": "Amend Journal Entry",
    "journal.composer.editSubtitle": "Update the saved decision and its authored note.",
    "journal.composer.persistenceNote": "Saving records or updates this decision only. It does not execute a trade.",
    "journal.composer.contextSection": "Linked Eye and action",
    "journal.composer.rationaleSection": "Why you decided",
    "journal.composer.reviewSection": "Thesis validity and timing",
    "journal.composer.optional": "Optional",
    ...
    "journal.validation.actionRequired": "Choose the action you recorded.",
    ...
    "recipes.builder.editTitle": "Edit Recipe",
    "recipes.builder.editSubtitle": "Your changes create a new version and keep the existing recipe version intact.",
    "recipes.builder.stepCount": ({ current, total }: Record<string, string | number> = {}) => `Step ${current ?? 1} of ${total ?? 4}`,
    "recipes.builder.requiredNow": "Required now",
    "recipes.builder.remaining": ({ steps }: Record<string, string | number> = {}) => `Still to review: ${steps ?? ""}`,
    "recipes.builder.required.purpose": "Recipe name and monitoring purpose",
    "recipes.builder.required.logic": "At least one monitoring condition",
    "recipes.builder.required.risk": "Review alert cooldown and risk notes",
    "recipes.builder.required.review": "Check review cadence and the draft summary",
    "recipes.builder.purposeSection": "Monitoring purpose",
    "recipes.builder.logicSection": "Monitoring logic",
    "recipes.builder.riskSection": "Risk and alert review",
    "recipes.builder.reviewSection": "Review before saving",
    "recipes.builder.metricMeaning": "What this metric represents",
    "recipes.builder.thresholdDecrease": "Decrease threshold",
    "recipes.builder.thresholdIncrease": "Increase threshold",
    "recipes.builder.thresholdBounds": ({ min, max, unit }: Record<string, string | number> = {}) => `Allowed range: ${min ?? ""} to ${max ?? ""}${unit ? ` ${unit}` : ""}.`,
    "recipes.builder.riskRulesNote": ({ count }: Record<string, string | number> = {}) => `${count ?? 0} configured condition(s) are marked as risk rules. Risk and disqualifier roles are part of the monitoring logic above.`,
    "recipes.builder.notesHint": "Optional note for later reviewers; keep criteria in the condition list above.",
    "recipes.builder.cooldownValue": ({ hours }: Record<string, string | number> = {}) => `${hours ?? 0} hours`,
    "recipes.builder.cadenceValue": ({ days }: Record<string, string | number> = {}) => `Every ${days ?? 0} days`,
    "recipes.builder.previewStockPlaceholder": "Search a stock for this sample preview",
    "recipes.builder.untitled": "Untitled Recipe",
    "recipes.builder.versionNote": "Saving creates a new version. Existing versions and linked history remain intact.",
    ...
    "recipes.builder.preview.disclosure": "Sample-data preview only. It does not promise returns or represent live execution.",
    ...
    "recipes.builder.action.saveVersion": "Save New Version",
  ...
  ko: {
    ...
    "workspace.handoff.title": "로컬 워커 검토 인계",
    "workspace.handoff.body": "폴더를 한 번 선택하면 앱을 열 때 이 브라우저가 워커 근거를 확인해 현재 워크스페이스에 추가합니다. 워커는 평가 묶음만 쓰고 이 폴더에서 영수증을 읽습니다. 예약 실행에는 직접 설정한 스케줄러와 켜진 기기가 필요합니다. 실시간 서비스나 이메일 영수증을 뜻하지 않습니다.",
    "workspace.handoff.chooseFolder": "워커 폴더 선택",
    "workspace.handoff.changeFolder": "워커 폴더 변경",
    "workspace.handoff.checkNow": "워커 업데이트 확인",
    "workspace.handoff.connected": "로컬 워커 폴더를 연결했습니다.",
    "workspace.handoff.checked": "로컬 워커 폴더를 확인했습니다.",
    "workspace.handoff.lastApplied": ({ at }: Record<string, string | number> = {}) => `최근 적용: ${at ?? "알 수 없음"}`,
    "workspace.handoff.pendingCount": ({ count }: Record<string, string | number> = {}) => `아직 적용되지 않은 워커 업데이트 ${count ?? 0}개`,
    "workspace.handoff.status.none": "연결된 로컬 워커 폴더 없음",
    "workspace.handoff.status.pending": "워커 근거 또는 폴더 권한 대기 중",
    "workspace.handoff.status.available": "워커 근거를 사용할 수 있음",
    "workspace.handoff.status.applied": "워커 근거를 이 워크스페이스에 적용함",
    "workspace.handoff.status.stale": "워커 인계가 48시간보다 오래됨",
    "workspace.handoff.status.partial": "일부 워커 기록을 사용할 수 있음. 추가 기록이 대기 중일 수 있음",
    "workspace.handoff.status.missed": "워커에서 누락 또는 일부 예약 세션을 보고함",
    "workspace.handoff.status.conflict": "소유자 변경과 충돌하여 아무것도 적용하지 않음",
    "workspace.handoff.status.failed": "인계를 완료하지 못함. 다시 시도할 수 있음",
    "workspace.handoff.status.recovered": "이전의 유효한 워크스페이스 복사본을 복원함",
    "workspace.handoff.error.permission_required": "워커 근거를 확인하려면 선택한 폴더에 대한 브라우저 접근 권한을 허용하세요.",
    "workspace.handoff.error.handoff_unavailable": "선택한 폴더를 읽거나 영수증을 쓸 수 없습니다. 폴더 권한을 확인한 뒤 다시 시도하세요.",
    "workspace.handoff.error.invalid_handoff": "인계 파일 검증에 실패했습니다. 저장된 워크스페이스는 변경되지 않았습니다.",
    "workspace.handoff.error.workspace_mismatch": "다른 워크스페이스용 인계입니다. 근거를 적용하지 않았습니다.",
    "workspace.handoff.error.sequence_gap": "워커 업데이트 순서에서 누락된 항목이 있습니다. 근거를 적용하지 않았습니다.",
    "workspace.handoff.error.owner_state_changed": "워커가 사용한 뒤 이 Eye가 변경되었습니다. 다시 시도하기 전에 충돌을 확인하세요.",
    "workspace.handoff.error.identity_collision": "워커가 다른 내용에 같은 근거 ID를 사용했습니다. 근거를 적용하지 않았습니다.",
    "workspace.handoff.error.storage_write_failed": "앱이 업데이트를 저장하지 못했습니다. 이전 저장본은 계속 복구할 수 있습니다.",
    "workspace.handoff.error.acknowledgement_failed": "근거는 앱에 저장됐지만 워커가 아직 영수증을 받지 못했습니다.",
    ...
    "settings.notifications.title": "알림 전달",
    "settings.notifications.note": "명시적으로 동의하고 이메일과 수신 주소를 저장하기 전까지 외부 전달은 꺼져 있습니다. 로컬 워커가 실행 중이어야 하며 Expo 앱이 백그라운드에서 이메일을 보내지는 않습니다.",
    "settings.notifications.configured": "이메일 주소 저장됨",
    "settings.notifications.unconfigured": "동의 또는 수신 주소 없음",
    "settings.notifications.enabled": "사용 중",
    "settings.notifications.off": "꺼짐",
    "settings.notifications.email": "이메일 수신 주소",
    "settings.notifications.emailPlaceholder": "name@example.com",
    "settings.notifications.enable": "이메일 전달 사용",
    "settings.notifications.disable": "옵트아웃하고 이후 전달 취소",
    "settings.notifications.disableConfirmTitle": "알림 전달을 끌까요?",
    "settings.notifications.disableConfirmBody": "수신 동의 해제와 허용 채널 비우기를 저장합니다. 별도 로컬 워커가 저장된 설정을 받을 때까지 인계 대기 상태가 표시될 수 있습니다.",
    "settings.notifications.disableConfirmCancel": "취소",
    "settings.notifications.disableConfirmConfirm": "알림 끄기",
    "settings.notifications.disableConfirmStatusNote": "설정 저장만 의미하며 워커나 프로바이더가 변경을 처리했다는 확인은 아닙니다.",
    "settings.notifications.saveFailed": "알림 설정을 저장하지 못했습니다. 변경 사항은 저장되지 않았습니다.",
    "settings.notifications.disableSaveFailed": "설정은 변경되지 않았습니다. 다시 저장하거나 취소하세요.",
    "settings.notifications.mode": "전달 방식",
    "settings.notifications.mode.immediate": "즉시",
    "settings.notifications.mode.digest": "다이제스트",
    "settings.notifications.digestTime": "다이제스트 시간 (HH:MM)",
    "settings.notifications.quietHours": "방해 금지 시간",
    "settings.notifications.quietStart": "시작 (HH:MM)",
    "settings.notifications.quietEnd": "종료 (HH:MM)",
    "settings.notifications.quietEnable": "방해 금지 시간에는 보류",
    "settings.notifications.quietDisable": "방해 금지 시간 끄기",
    "settings.notifications.privacy": "콘텐츠 개인정보 보호",
    "settings.notifications.privacy.minimal": "최소 안전 메시지",
    "settings.notifications.privacy.rich": "명시적 동의가 필요한 상세 내용",
    "settings.notifications.save": "알림 설정 저장",
    "settings.notifications.lastStatus": "최근 전달 상태: 워커에서만 확인할 수 있으며 앱은 영수증을 주장하지 않습니다.",
    "settings.notifications.workerStatus": "전달 영수증은 앱 화면이 아닌 서버 전용 로컬 워커에 기록됩니다. 대기 중인 알림은 전달된 알림이 아닙니다.",
    "settings.notifications.handoffNote": "이 기기의 알림 설정은 백업을 명시적으로 내보내 별도 워커에 가져온 후에만 워커에 적용됩니다.",
    "settings.notifications.pendingWorkerHandoff": "워커 인계 대기: 이 앱의 설정이 워커가 마지막으로 적용한 설정보다 최신입니다.",
    "settings.notifications.noLastKnownState": "가져온 워커의 최근 전달 상태가 아직 없습니다.",
    "settings.notifications.lastKnownState": ({ state, at, attempts }: Record<string, string | number> = {}) => `워커 최근 상태(실시간 모니터링 아님): ${state ?? "없음"}; 기록 시각 ${at ?? "알 수 없음"}; 시도 ${attempts ?? 0}회.`,
    "settings.notifications.state.none": "아직 전달 없음",
    "settings.notifications.state.pending": "대기 중",
    "settings.notifications.state.held": "보류 중",
    "settings.notifications.state.claimed": "처리 중",
    "settings.notifications.state.delivered": "테스트/프로바이더 계약상 확인됨",
    "settings.notifications.state.failed": "실패 — 재시도 한도 소진",
    "settings.notifications.state.retry-wait": "재시도 대기",
    "settings.notifications.state.canceled": "취소됨 / 비활성화됨",
    "settings.notifications.state.blocked-unconfigured": "차단됨 — 워커 채널 미설정",
    "settings.notifications.state.ambiguous": "모호함 — 프로바이더 결과 확인 필요",
    "settings.notifications.privacyNote": "최소 메시지에는 투자 논리, 메모, 보유 내역, 근거 또는 클라우드 데이터가 포함되지 않습니다.",
    ...
    "eyes.detail.noVersion": "버전이 기록되지 않음",
    "eyes.detail.cadenceElapsed": "레시피 검토 주기가 지났습니다.",
    ...
    "eyes.create.persistenceNote": "저장하면 모니터링 의도만 기록됩니다. 거래를 실행하거나 투자 행동을 권하지 않습니다.",
    "eyes.create.optionalNote": "검토에 도움이 될 때만 입력하세요. 비워 두어도 저장할 수 있습니다.",
    "eyes.create.rangePositive": "0보다 큰 숫자를 입력하거나 선택 입력란을 비워 두세요.",
    "eyes.create.rangeLowOrder": "진입 하단은 상단보다 클 수 없습니다.",
    "eyes.create.rangeHighOrder": "진입 상단은 하단보다 작을 수 없습니다.",
    "eyes.create.submit": "모니터 만들기",
    "authoring.required": "필수",
    "authoring.requiredSection": "먼저 입력할 항목",
    "authoring.optionalSection": "선택 맥락",
    "authoring.noMatches": "일치하는 항목이 없습니다. 검색어를 바꿔 보세요.",
    ...
    "journal.composer.editTitle": "저널 기록 수정",
    "journal.composer.editSubtitle": "저장된 결정과 직접 작성한 메모를 수정합니다.",
    "journal.composer.persistenceNote": "이 결정 기록을 저장하거나 수정합니다. 거래를 실행하지 않습니다.",
    "journal.composer.contextSection": "연결된 모니터와 행동",
    "journal.composer.rationaleSection": "결정 이유",
    "journal.composer.reviewSection": "논리 유효성과 타이밍",
    "journal.composer.optional": "선택",
    ...
    "journal.validation.actionRequired": "기록할 행동을 선택하세요.",
    ...
    "recipes.builder.editTitle": "레시피 수정",
    "recipes.builder.editSubtitle": "변경 내용은 새 버전으로 저장되며 기존 레시피 버전은 유지됩니다.",
    "recipes.builder.stepCount": ({ current, total }: Record<string, string | number> = {}) => `${total ?? 4}단계 중 ${current ?? 1}단계`,
    "recipes.builder.requiredNow": "지금 필요한 입력",
    "recipes.builder.remaining": ({ steps }: Record<string, string | number> = {}) => `이후 검토: ${steps ?? ""}`,
    "recipes.builder.required.purpose": "레시피 이름과 모니터링 목적",
    "recipes.builder.required.logic": "최소 한 개의 모니터링 조건",
    "recipes.builder.required.risk": "알림 간격과 위험 메모 검토",
    "recipes.builder.required.review": "검토 주기와 초안 요약 확인",
    "recipes.builder.purposeSection": "모니터링 목적",
    "recipes.builder.logicSection": "모니터링 논리",
    "recipes.builder.riskSection": "위험과 알림 검토",
    "recipes.builder.reviewSection": "저장 전 검토",
    "recipes.builder.metricMeaning": "이 지표의 의미",
    "recipes.builder.thresholdDecrease": "기준값 낮추기",
    "recipes.builder.thresholdIncrease": "기준값 높이기",
    "recipes.builder.thresholdBounds": ({ min, max, unit }: Record<string, string | number> = {}) => `허용 범위: ${min ?? ""} ~ ${max ?? ""}${unit ? ` ${unit}` : ""}.`,
    "recipes.builder.riskRulesNote": ({ count }: Record<string, string | number> = {}) => `위험 규칙으로 표시된 조건 ${count ?? 0}개입니다. 위험 경고와 강제 제외 역할은 위 모니터링 논리에 포함됩니다.`,
    "recipes.builder.notesHint": "나중에 검토할 메모를 적으세요. 기준은 위 조건 목록에 둡니다.",
    "recipes.builder.cooldownValue": ({ hours }: Record<string, string | number> = {}) => `${hours ?? 0}시간`,
    "recipes.builder.cadenceValue": ({ days }: Record<string, string | number> = {}) => `${days ?? 0}일마다`,
    "recipes.builder.previewStockPlaceholder": "샘플 미리보기에 사용할 종목 검색",
    "recipes.builder.untitled": "이름 없는 레시피",
    "recipes.builder.versionNote": "저장하면 새 버전이 만들어집니다. 기존 버전과 연결 이력은 유지됩니다.",
    ...
    "recipes.builder.preview.disclosure": "샘플 데이터 미리보기입니다. 수익 보장이나 실거래 실행을 의미하지 않습니다.",
    ...
    "recipes.builder.action.saveVersion": "새 버전 저장",
